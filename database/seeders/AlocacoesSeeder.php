...
class AlocacoesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('alocacoes')->insert(['projeto_id' => 2, 'desenvolvedor_id' => 1, 'horas_semanais' => 13]);
        ...
        DB::table('alocacoes')->insert(['projeto_id' => 2, 'desenvolvedor_id' => 2, 'horas_semanais' => 18]);
    }
}
